...
import com.thinkgem.jeesite.modules.sys.dao.Demo1Dao;
import com.thinkgem.jeesite.modules.sys.dao.Demo2Dao;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	public List<Demo1> getDemo1List() {
		return demo1Dao.findList();
	}
	
	public List<Demo2> getDemo2List() {
		return demo2Dao.findList();
	}
	...
	public Page<User> findUser(Page<User> page, User user) {
		...
		if(user.getCurrentUser().isAdmin()) {
			...
			user.getSqlMap().put("dsf", "AND (a.create_by = '"+id+"' or a.id = '"+id+"')");
		}
