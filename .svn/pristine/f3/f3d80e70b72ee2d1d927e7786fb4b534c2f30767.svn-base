...
public class TimeUtils {
	...
	public static String parseDateTime(String datetime) throws ParseException {
		...
		return sdf2.format(d) + index;
	}

	public static String TIME19 = "yyyy-MM-dd HH:mm:ss";

	public static String getTime19(int hour) {
		try {
			...
			return formatDateToString(c.getTime(), TIME19);
		} catch (Exception ex) {
			return null;
		}
	}
	 ...
	 * @return
	 * @author shenyang
	 * @created 2015-10-20 上午10:52:41
	 */
	public static String getYesterHour(String data, int num) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		...
		try {
			...
			if (calendar == null) {
				...
				dayBefore = new SimpleDateFormat(TIME19).format(calendar.getTime());
				return dayBefore;
			}
	 ...
	 * @return
	 */
	public static String getYesterMinute(String data, int num) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		Calendar calendar = null;
		String dayBefore = "";
		try {
	 ...
	 * @return
	 */
	public static String getBeforeMinute(String data, int num) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		Calendar calendar = null;
		String dayBefore = "";
		try {
	...
	public static String formatDateToString(Date date, String pattern) throws Exception {
		...
		try {
			dateFormat = new java.text.SimpleDateFormat(pattern);
