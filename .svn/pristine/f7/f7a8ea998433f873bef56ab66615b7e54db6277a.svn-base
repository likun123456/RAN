...
/**
 * 单用户信令追踪PCRF抓包过滤msisdnEntity
 * @author zhuguangrui
 * @version 2017-06-16
 */
public class TCapPcrfFilterPath extends DataEntity<TCapPcrfFilterPath> {
	...
	public TCapPcrfFilterPath() {
		super();
	}

	public TCapPcrfFilterPath(String id){
		super(id);
	}
