...
window.onload=setInterval(function() {
	...
	function queryMap(){
		document.forms[0].action = "${ctx}/userquery/MapManager?poolName=${poolName}";
		document.forms[0].submit();
	}
			...
			<table style="width: 100%;height:100%">
				<tr>
					<c:forEach items="${mainData}" var="entry" varStatus="status">
						...
						<td style="width: 50%;">
							<table style="width: 99%; height: 170px">
								...
								<tr style="background: white">
									...
									<c:forEach items="${entry.value}" var="comment">
										...
										<div style="float:left;width:16%;margin-left:3px;text-align:center;height: 145px; padding-top: 25px">
										<span class="${comment.iconName}" style="font-size: 40px;"></span>
										 <br>
										 <br>
											<c:choose>
