	...
	<script type="text/javascript">
		...
		function queryTable(){
			...
			$('#table').bootstrapTable({
				url:'${ctx}/performance/tEciSuccessRate/queryEbmLogByEci',
		        method:'POST',
		        dataType:'json',
		        cache:false,
		        ...
		        queryParams:  function(params) {
					 ...
					 eci = window.opener.document.getElementById("eci").value;
		        	 return {
		        ...
		        onLoadSuccess: function (data) {
		        	...
		        	$("#chart_outside_div ul li").eq(2).html("<b>ECI："+eci+"  统计时段："+startTime+"-"+endTime+"</b>")
		        	$("#table_outside_div ul li").eq(1).html("<b>"+$('#eventType option:selected').text()+"EBMLOG原因值统计</b>")
		        	$("#table_outside_div ul li").eq(2).html("<b>ECI："+eci+"  统计时段："+startTime+"-"+endTime+"</b>")
		        },
