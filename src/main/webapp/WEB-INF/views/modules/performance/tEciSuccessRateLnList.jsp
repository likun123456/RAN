			...
			$("#searchForm").validate({
				submitHandler: function(form){
					if ($("#netid option:selected").val()==""){
	                	...
	                	if($("#searchForm").attr('action')=="/epc/a/performance/tEciSuccessRate/exportLnExcel"){
	                		form.submit();
...
<body>
	...
	<form:form id="searchForm" modelAttribute="tEciSuccessRate" class="breadcrumb form-search" action="">
		<ul class="ul-form">
			...
			<li class="btns"><input id="exportBtn" class="btn-new btn-save" value="导出" type="submit" onclick="searchForm.action='${ctx}/performance/tEciSuccessRate/exportLnExcel';"/></li>
		</ul>
	</form:form>
