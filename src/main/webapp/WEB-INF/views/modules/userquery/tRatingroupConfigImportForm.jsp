...
<head>
	...
	function doSubmit(){
		...
		document.forms[0].action = "${ctx}/userquery/ratingroupConfig/importAction";
...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="userquery:ratingroupConfig:import"><li class="active"><a href="${ctx}/userquery/ratingroupConfig/importForm">导入</a></li></shiro:hasPermission>
	</ul>
